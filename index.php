...
define('BASE_URL', '/achridep_toDo/comem-archidep-php-todo-exercise/');
...
if (isset($_POST['action'])) {
  switch ($_POST['action']) {
    ...
    case 'toggle':
      ...
      $id = $_POST['id'];
      if (is_numeric($id)) {
        $updateQuery = 'UPDATE todo SET done = NOT done WHERE id =' . $id . ''; //IMPLEMENTED
 ...
 */
$selectQuery = 'SELECT * FROM todo ORDER BY created_at DESC'; // IMPLEMENTED
